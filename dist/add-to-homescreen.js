...
function AddToHomeScreen(options) {
    ...
    function _genIOSSafariIOS26(container) {
        var containerInnerHTML = _genModalStart() +
            ...
            _genListItem(`3`, simpleI18n_1.default.__("Tap %s", _genListButtonWithImage(_genAssetUrl("ios-safari-ios26-more-grey-arrow-button.svg"), simpleI18n_1.default.__("View More"), "left"))) +
    ...
    function _genIOSIPadSafariIOS26(container) {
        var containerInnerHTML = _genModalStart() +
            ...
            _genListItem(`2`, simpleI18n_1.default.__("Tap %s", _genListButtonWithImage(_genAssetUrl("ios-safari-ios26-more-grey-arrow-button.svg"), simpleI18n_1.default.__("View More"), "left"))) +
    ...
    function _genIOSSafariIOS27(container) {
        var containerInnerHTML = _genModalStart() +
            ...
            _genListItem(`2`, simpleI18n_1.default.__("Tap %s in the menu.", _genListButtonWithImage(_genAssetUrl("ios-safari-ios26-share-button.svg"), simpleI18n_1.default.__("Share"), "left"))) +
            _genListItem(`3`, simpleI18n_1.default.__("Tap %s", _genListButtonWithImage(_genAssetUrl("ios-safari-ios27-more-grey-arrow-button.svg"), simpleI18n_1.default.__("View More"), "left"))) +
            _genListItem(`4`, simpleI18n_1.default.__("Select %s from the menu.", _genListButtonWithImage(_genAssetUrl("ios-safari-add-to-home-screen-button-2.svg"), simpleI18n_1.default.__("Add to Home Screen"), "left"))) +
            _genListEnd() +
            _genBlurbMobile() +
            _genModalEnd() +
    ...
    function _genAndroidChrome(container) {
        var containerInnerHTML = _genModalStart() +
            ...
            _genListItem(`2`, simpleI18n_1.default.__("Tap %s", _genListButtonWithImage(_genAssetUrl("android-chrome-install-and-create-shortcut.svg"), simpleI18n_1.default.__("Install and create shortcut"), "left"))) +
            // _genListItem(`3`, i18n.__('Open the %s app.', `<img class="adhs-your-app-icon" src="${appIconUrl}"/>`)) +
            _genListEnd() +
            _genBlurbMobile() +
            _genModalEnd() +
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"Přidat na plochu","Add To Dock":"Přidat do Docku","An icon will be added to your Dock so you can quickly access this website.":"Ikona bude přidána do vašeho Docku, abyste měli rychlý přístup k této webové stránce.","An icon will be added to your home screen so you can quickly access this website.":"Ikona bude přidána na vaši domovskou obrazovku, abyste měli rychlý přístup k této webové stránce.","An icon will be added to your Taskbar so you can quickly access this website.":"Ikona bude přidána na váš panel úloh, abyste měli rychlý přístup k této webové stránce.","Install":"Instalovat","Install %s":"Instalovat %s","Install and create shortcut":"Nainstalovat a vytvořit zástupce","Install app":"Instalovat aplikaci","Later":"Později","Open in browser":"Otevřít v prohlížeči","Select %s from the menu that pops up.":"Vyberte %s z nabídky, která se zobrazí.","Select %s from the menu.":"Vyberte %s z nabídky.","Share":"Sdílet","Tap":"Klepněte na","Tap %s":"Klepněte na %s","Tap %s in the browser bar.":"Klepněte na %s v panelu prohlížeče.","Tap %s in the menu.":"Klepněte na %s v nabídce.","Tap %s in the toolbar.":"Klepněte na %s v panelu nástrojů.","Tap the %s button above.":"Klepněte na tlačítko %s výše.","Tap the %s button below to open your system browser.":"Klepněte na tlačítko %s níže pro otevření systémového prohlížeče.","Tap the %s button in the toolbar.":"Klepněte na tlačítko %s v panelu nástrojů.","Tap the %s button in the upper right corner.":"Klepněte na tlačítko %s v pravém horním rohu.","View More":"Zobrazit více","You may need to scroll down to find this menu item.":"Možná budete muset posunout dolů, abyste tuto položku nabídky našli."}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"Føj til hjemmeskærm","Add To Dock":"Tilføj til dock","An icon will be added to your Dock so you can quickly access this website.":"Et ikon vil blive tilføjet til din dock, så du hurtigt kan få adgang til dette website.","An icon will be added to your home screen so you can quickly access this website.":"Et ikon vil blive tilføjet til din hjemmeskærm, så du hurtigt kan få adgang til dette website.","An icon will be added to your Taskbar so you can quickly access this website.":"Et ikon vil blive tilføjet til din proceslinje, så du hurtigt kan få adgang til dette website.","Install":"Installer","Install %s":"Installer %s","Install and create shortcut":"Installer og opret genvej","Install app":"Installer app","Later":"Senere","Open in browser":"Åbn i browser","Select %s from the menu that pops up.":"Vælg %s fra menuen, der dukker op.","Select %s from the menu.":"Vælg %s fra menuen.","Share":"Del","Tap":"Tryk på","Tap %s":"Tryk på %s","Tap %s in the browser bar.":"Tryk på %s i browserlinjen.","Tap %s in the toolbar.":"Tryk på %s i værktøjslinjen.","Tap the %s button above.":"Tryk på %s-knappen ovenfor.","Tap the %s button below to open your system browser.":"Tryk på %s-knappen nedenfor for at åbne din systembrowser.","Tap the %s button in the toolbar.":"Tryk på %s-knappen i værktøjslinjen.","Tap the %s button in the upper right corner.":"Tryk på %s-knappen i øverste højre hjørne.","Tap %s in the menu.":"Tryk på %s i menuen.","View More":"Vis mere","You may need to scroll down to find this menu item.":"Du skal måske rulle ned for at finde dette menupunkt."}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"Zum Home-Bildschirm","Add To Dock":"Zum Dock hinzufügen","An icon will be added to your Dock so you can quickly access this website.":"Ein Symbol wird zu Ihrem Dock hinzugefügt, damit Sie schnell auf diese Website zugreifen können.","An icon will be added to your home screen so you can quickly access this website.":"Ein Symbol wird zu Ihrem Startbildschirm hinzugefügt, damit Sie schnell auf diese Website zugreifen können.","An icon will be added to your Taskbar so you can quickly access this website.":"Ein Symbol wird zu Ihrer Taskleiste hinzugefügt, damit Sie schnell auf diese Website zugreifen können.","Install":"Installieren","Install %s":"%s installieren","Install and create shortcut":"Installieren und Verknüpfung erstellen","Install app":"App installieren","Later":"Später","Open in browser":"Im Browser öffnen","Select %s from the menu that pops up.":"Wählen Sie %s aus dem Menü, das erscheint.","Select %s from the menu.":"Wählen Sie %s aus dem Menü.","Share":"Teilen","Tap":"Tippen Sie auf","Tap %s":"Tippen Sie auf %s","Tap %s in the browser bar.":"Tippen Sie auf %s in der Browserleiste.","Tap %s in the menu.":"Tippen Sie auf %s im Menü.","Tap %s in the toolbar.":"Tippen Sie auf %s in der Symbolleiste.","Tap the %s button above.":"Tippen Sie oben auf die Schaltfläche %s.","Tap the %s button below to open your system browser.":"Tippen Sie unten auf die Schaltfläche %s, um Ihren Systembrowser zu öffnen.","Tap the %s button in the toolbar.":"Tippen Sie auf die Schaltfläche %s in der Symbolleiste.","Tap the %s button in the upper right corner.":"Tippen Sie auf die Schaltfläche %s in der oberen rechten Ecke.","View More":"Mehr anzeigen","You may need to scroll down to find this menu item.":"Sie müssen möglicherweise nach unten scrollen, um diesen Menüpunkt zu finden."}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"Add to Home Screen","Add To Dock":"Add To Dock","An icon will be added to your Dock so you can quickly access this website.":"An icon will be added to your Dock so you can quickly access this website.","An icon will be added to your home screen so you can quickly access this website.":"An icon will be added to your home screen so you can quickly access this website.","An icon will be added to your Taskbar so you can quickly access this website.":"An icon will be added to your Taskbar so you can quickly access this website.","Install":"Install","Install %s":"Install %s","Install and create shortcut":"Install and create shortcut","Install app":"Install app","Later":"Later","Open in browser":"Open in browser","Select %s from the menu that pops up.":"Select %s from the menu that pops up.","Select %s from the menu.":"Select %s from the menu.","Share":"Share","Tap":"Tap","Tap %s":"Tap %s","Tap %s in the browser bar.":"Tap %s in the browser bar.","Tap %s in the menu.":"Tap %s in the menu.","Tap %s in the toolbar.":"Tap %s in the toolbar.","Tap the %s button above.":"Tap the %s button above.","Tap the %s button below to open your system browser.":"Tap the %s button below to open your system browser.","Tap the %s button in the toolbar.":"Tap the %s button in the toolbar.","Tap the %s button in the upper right corner.":"Tap the %s button in the upper right corner.","View More":"View More","You may need to scroll down to find this menu item.":"You may need to scroll down to find this menu item."}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"Agregar a Inicio","Add To Dock":"Añadir al Dock","An icon will be added to your Dock so you can quickly access this website.":"Se añadirá un icono a tu Dock para que puedas acceder rápidamente a este sitio web.","An icon will be added to your home screen so you can quickly access this website.":"Se añadirá un icono a tu pantalla de inicio para que puedas acceder rápidamente a este sitio web.","An icon will be added to your Taskbar so you can quickly access this website.":"Se añadirá un icono a tu barra de tareas para que puedas acceder rápidamente a este sitio web.","Install":"Instalar","Install %s":"Instalar %s","Install and create shortcut":"Instalar y crear acceso directo","Install app":"Instalar aplicación","Later":"Más tarde","Open in browser":"Abrir en el navegador","Select %s from the menu that pops up.":"Selecciona %s del menú emergente.","Select %s from the menu.":"Seleccione %s del menú.","Share":"Compartir","Tap":"Toca","Tap %s":"Toca %s","Tap %s in the browser bar.":"Toca %s en la barra del navegador.","Tap %s in the menu.":"Toque %s en el menú.","Tap %s in the toolbar.":"Toca %s en la barra de herramientas.","Tap the %s button above.":"Toca el botón %s de arriba.","Tap the %s button below to open your system browser.":"Toca el botón %s de abajo para abrir el navegador de tu sistema.","Tap the %s button in the toolbar.":"Toca el botón %s en la barra de herramientas.","Tap the %s button in the upper right corner.":"Toca el botón %s en la esquina superior derecha.","View More":"Ver más","You may need to scroll down to find this menu item.":"Es posible que necesites desplazarte hacia abajo para encontrar este elemento del menú."}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"הוסף למסך הבית","Add To Dock":"הוסף לדוק","An icon will be added to your Dock so you can quickly access this website.":"אייקון יתווסף לדוק שלך כדי שתוכל לגשת במהירות לאתר זה.","An icon will be added to your home screen so you can quickly access this website.":"אייקון יתווסף למסך הבית שלך כדי שתוכל לגשת במהירות לאתר זה.","An icon will be added to your Taskbar so you can quickly access this website.":"אייקון יתווסף לשורת המשימות שלך כדי שתוכל לגשת במהירות לאתר זה.","Install":"התקן","Install %s":"התקן %s","Install and create shortcut":"התקנה ויצירת קיצור דרך","Install app":"התקן אפלקציה","Later":"מאוחר יותר","Open in browser":"פתח בדפדפן","Select %s from the menu that pops up.":"בחר ב %s מהתפריט שנפתח.","Select %s from the menu.":"בחר ב%s מהתפריט.","Share":"שתף","Tap":"לחץ על","Tap %s":"לחץ על %s","Tap %s in the menu.":"לחץ על %s בתפריט.","Tap %s in the browser bar.":"לחץ על %s בשורת הדפדפן.","Tap %s in the toolbar.":"לחץ על %s בסרגל הכלים.","Tap the %s button above.":"לחץ על הכפתור %s למעלה.","Tap the %s button below to open your system browser.":"לחץ על הכפתור %s למטה כדי לפתוח את דפדפן המערכת שלך.","Tap the %s button in the toolbar.":"לחץ על הכפתור %s בסרגל הכלים.","Tap the %s button in the upper right corner.":"לחץ על הכפתור %s בפינה הימנית העליונה.","View More":"הצג עוד","You may need to scroll down to find this menu item.":"יתכן שתצטרך לגלול למטה כדי למצוא פריט זה בתפריט."}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"Pievienot sākuma ekrānam","Add To Dock":"Pievienot Dock","An icon will be added to your Dock so you can quickly access this website.":"Ikona tiks pievienota jūsu Dock, lai jūs varētu ātri piekļūt šai vietnei.","An icon will be added to your home screen so you can quickly access this website.":"Ikona tiks pievienota jūsu sākuma ekrānam, lai jūs varētu ātri piekļūt šai vietnei.","An icon will be added to your Taskbar so you can quickly access this website.":"Ikona tiks pievienota jūsu uzdevumjoslai, lai jūs varētu ātri piekļūt šai vietnei.","Install":"Instalēt","Install %s":"Instalēt %s","Install and create shortcut":"Instalēt un izveidot saīsni","Install app":"Instalēt lietotni","Later":"Vēlāk","Open in browser":"Atvērt pārlūkā","Select %s from the menu that pops up.":"Izvēlieties %s no uzlecošās izvēlnes.","Select %s from the menu.":"Izvēlieties %s no izvēlnes.","Share":"Dalīties","Tap":"Pieskarieties","Tap %s":"Pieskarieties %s","Tap %s in the menu.":"Pieskarieties %s izvēlnē.","Tap %s in the browser bar.":"Pieskarieties %s pārlūka joslā.","Tap %s in the toolbar.":"Pieskarieties %s rīkjoslā.","Tap the %s button above.":"Pieskarieties pogai %s augstāk.","Tap the %s button below to open your system browser.":"Pieskarieties pogai %s zemāk, lai atvērtu sistēmas pārlūku.","Tap the %s button in the toolbar.":"Pieskarieties pogai %s rīkjoslā.","Tap the %s button in the upper right corner.":"Pieskarieties pogai %s augšējā labajā stūrī.","View More":"Skatīt vairāk","You may need to scroll down to find this menu item.":"Jums, iespējams, būs jāpārskrollē uz leju, lai atrastu šo izvēlnes vienumu."}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"Toevoegen aan beginscherm","Add To Dock":"Toevoegen aan Dock","An icon will be added to your Dock so you can quickly access this website.":"Er wordt een pictogram toegevoegd aan je Dock, zodat je snel toegang hebt tot deze website.","An icon will be added to your home screen so you can quickly access this website.":"Er wordt een pictogram toegevoegd aan je beginscherm, zodat je snel toegang hebt tot deze website.","An icon will be added to your Taskbar so you can quickly access this website.":"Er wordt een pictogram toegevoegd aan je taakbalk, zodat je snel toegang hebt tot deze website.","Install":"Installeren","Install %s":"%s installeren","Install and create shortcut":"Installeren en snelkoppeling maken","Install app":"App installeren","Later":"Later","Open in browser":"Openen in browser","Select %s from the menu that pops up.":"Selecteer %s in het menu dat verschijnt.","Select %s from the menu.":"Selecteer %s in het menu.","Share":"Deel","Tap":"Tik op","Tap %s":"Tik op %s","Tap %s in the browser bar.":"Tik op %s in de browserbalk.","Tap %s in the menu.":"Tik op %s in het menu.","Tap %s in the toolbar.":"Tik op %s in de werkbalk.","Tap the %s button above.":"Tik bovenaan op de knop %s.","Tap the %s button below to open your system browser.":"Tik onderaan op de knop %s om je systeembrowser te openen.","Tap the %s button in the toolbar.":"Tik op de knop %s in de werkbalk.","Tap the %s button in the upper right corner.":"Tik op de knop %s in de rechterbovenhoek.","View More":"Toon meer","You may need to scroll down to find this menu item.":"Je moet mogelijk naar beneden scrollen om dit menu-item te vinden."}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"Adicionar à Tela de Inicio","Add To Dock":"Adicionar à Dock","An icon will be added to your Dock so you can quickly access this website.":"Um ícone será adicionado à sua Dock para que você possa acessar rapidamente este site.","An icon will be added to your home screen so you can quickly access this website.":"Um ícone será adicionado à sua tela inicial para que você possa acessar rapidamente este site.","An icon will be added to your Taskbar so you can quickly access this website.":"Um ícone será adicionado à sua barra de tarefas para que você possa acessar rapidamente este site.","Install":"Instalar","Install %s":"Instalar %s","Install and create shortcut":"Instalar e criar atalho","Install app":"Instalar aplicativo","Later":"Mais tarde","Open in browser":"Abrir no navegador","Select %s from the menu that pops up.":"Selecione %s no menu que aparece.","Select %s from the menu.":"Selecione %s no menu.","Share":"Compartilhar","Tap":"Toque em","Tap %s":"Toque em %s","Tap %s in the browser bar.":"Toque em %s na barra do navegador.","Tap %s in the menu.":"Toque em %s no menu.","Tap %s in the toolbar.":"Toque em %s na barra de ferramentas.","Tap the %s button above.":"Toque no botão %s acima.","Tap the %s button below to open your system browser.":"Toque no botão %s abaixo para abrir o navegador do sistema.","Tap the %s button in the toolbar.":"Toque no botão %s na barra de ferramentas.","Tap the %s button in the upper right corner.":"Toque no botão %s no canto superior direito.","View More":"Ver mais","You may need to scroll down to find this menu item.":"Você pode precisar rolar para baixo para encontrar este item do menu."}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"Adaugă pe ecranul de pornire","Add To Dock":"Adaugă în Dock","An icon will be added to your Dock so you can quickly access this website.":"Adăugăm o pictogramă în Dock, ca să poți deschide rapid acest site.","An icon will be added to your home screen so you can quickly access this website.":"Adăugăm o pictogramă pe ecranul de pornire, ca să poți deschide rapid acest site.","An icon will be added to your Taskbar so you can quickly access this website.":"Adăugăm o pictogramă în bara de activități, ca să poți deschide rapid acest site.","Install":"Instalează","Install %s":"Instalează %s","Install and create shortcut":"Instalează și creează o comandă rapidă","Install app":"Instalează aplicația","Later":"Mai târziu","Open in browser":"Deschide în browser","Select %s from the menu that pops up.":"Alege %s din meniul care apare.","Select %s from the menu.":"Alege %s din meniu.","Share":"Distribuie","Tap":"Apasă pe","Tap %s":"Apasă pe %s","Tap %s in the browser bar.":"Apasă pe %s în bara browserului.","Tap %s in the menu.":"Apasă pe %s în meniu.","Tap %s in the toolbar.":"Apasă pe %s în bara de instrumente.","Tap the %s button above.":"Apasă pe butonul %s de mai sus.","Tap the %s button below to open your system browser.":"Apasă pe butonul %s de mai jos ca să deschizi browserul implicit.","Tap the %s button in the toolbar.":"Apasă pe butonul %s din bara de instrumente.","Tap the %s button in the upper right corner.":"Apasă pe butonul %s din colțul din dreapta sus.","View More":"Vezi mai mult","You may need to scroll down to find this menu item.":"S-ar putea să trebuiască să derulezi în jos ca să găsești această opțiune."}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"Dodaj na začetni zaslon","Add To Dock":"Dodaj v Dock","An icon will be added to your Dock so you can quickly access this website.":"Da boste lahko hitro dostopali do te spletne strani, bo ikona dodana v Dock.","An icon will be added to your home screen so you can quickly access this website.":"Da boste lahko hitro dostopali do te spletne strani, bo ikona dodana na začetni zaslon.","An icon will be added to your Taskbar so you can quickly access this website.":"Da boste lahko hitro dostopali do te spletne strani, bo ikona dodana v opravilno vrstico.","Install":"Namesti","Install %s":"Namesti %s","Install and create shortcut":"Namesti in ustvari bližnjico","Install app":"Namesti aplikacijo","Later":"Kasneje","Open in browser":"Odpri v brskalniku","Select %s from the menu that pops up.":"V pojavnem meniju izberite %s.","Select %s from the menu.":"V meniju izberite %s.","Share":"Deli","Tap":"Izberite","Tap %s":"Izberite %s","Tap %s in the menu.":"V meniju izberite %s.","Tap %s in the browser bar.":"V vrstici brskalnika izberite %s.","Tap %s in the toolbar.":"V orodni vrstici izberite %s.","Tap the %s button above.":"Izberite zgornji gumb %s.","Tap the %s button below to open your system browser.":"Za odpiranje brskalnika izberite spodnji gumb %s.","Tap the %s button in the toolbar.":"V orodni vrstici izberite gumb %s.","Tap the %s button in the upper right corner.":"V zgornjem desnem kotu izberite gumb %s.","View More":"Prikaži več","You may need to scroll down to find this menu item.":"Da boste našli ta element, se bo morda potrebno pomakniti navzdol."}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"เพิ่มลงในหน้าจอโฮม","Add To Dock":"เพิ่มลงใน Dock","An icon will be added to your Dock so you can quickly access this website.":"ไอคอนจะถูกเพิ่มลงใน Dock เพื่อให้คุณสามารถเข้าถึงเว็บไซต์นี้ได้อย่างรวดเร็ว","An icon will be added to your home screen so you can quickly access this website.":"ไอคอนจะถูกเพิ่มลงในหน้าจอโฮมเพื่อให้คุณสามารถเข้าถึงเว็บไซต์นี้ได้อย่างรวดเร็ว","An icon will be added to your Taskbar so you can quickly access this website.":"ไอคอนจะถูกเพิ่มลงในทาสก์บาร์เพื่อให้คุณสามารถเข้าถึงเว็บไซต์นี้ได้อย่างรวดเร็ว","Install":"ติดตั้ง","Install %s":"ติดตั้ง %s","Install and create shortcut":"ติดตั้งและสร้างทางลัด","Install app":"ติดตั้งแอป","Later":"ภายหลัง","Open in browser":"เปิดในเบราว์เซอร์","Select %s from the menu that pops up.":"เลือก %s จากเมนูที่แสดงขึ้น","Select %s from the menu.":"เลือก %s จากเมนู","Share":"แชร์","Tap":"แตะ","Tap %s":"แตะ %s","Tap %s in the browser bar.":"แตะ %s ในแถบเบราว์เซอร์","Tap %s in the menu.":"แตะ %s ในเมนู","Tap %s in the toolbar.":"แตะ %s ในแถบเครื่องมือ","Tap the %s button above.":"แตะปุ่ม %s ด้านบน","Tap the %s button below to open your system browser.":"แตะปุ่ม %s ด้านล่างเพื่อเปิดเบราว์เซอร์ของระบบ","Tap the %s button in the toolbar.":"แตะปุ่ม %s ในแถบเครื่องมือ","Tap the %s button in the upper right corner.":"แตะปุ่ม %s ที่มุมบนขวา","View More":"ดูเพิ่มเติม","You may need to scroll down to find this menu item.":"คุณอาจจะต้องเลื่อนลงเพื่อค้นหารายการเมนูนี้"}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"加入主畫面","Add To Dock":"加入程序塢","An icon will be added to your Dock so you can quickly access this website.":"一個圖示將被加入你的程序塢，以便你可以快速存取這個網站。","An icon will be added to your home screen so you can quickly access this website.":"一個圖示將被加入你的主畫面，以便你可以快速存取這個網站。","An icon will be added to your Taskbar so you can quickly access this website.":"一個圖示將被加入你的工作列，以便你可以快速存取這個網站。","Install":"安裝","Install %s":"安裝 %s","Install and create shortcut":"安裝並建立捷徑","Install app":"安裝應用程式","Later":"稍後","Open in browser":"在瀏覽器中打開","Select %s from the menu that pops up.":"從彈出的選單中選擇 %s。","Select %s from the menu.":"從選單中選擇 %s。","Share":"分享","Tap":"點擊","Tap %s":"點擊 %s","Tap %s in the browser bar.":"在瀏覽器欄中點擊 %s。","Tap %s in the menu.":"在選單中點擊 %s。","Tap %s in the toolbar.":"在工具列中點擊 %s。","Tap the %s button above.":"點擊上面的 %s 按鈕。","Tap the %s button below to open your system browser.":"點擊下面的 %s 按鈕以打開你的系統瀏覽器。","Tap the %s button in the toolbar.":"點擊工具列中的 %s 按鈕。","Tap the %s button in the upper right corner.":"點擊右上角的 %s 按鈕。","View More":"查看更多","You may need to scroll down to find this menu item.":"你可能需要向下捲動才能找到這個菜單項目。"}');
...
"use strict";
module.exports = JSON.parse('{"Add to Home Screen":"加入主畫面","Add To Dock":"加入 Dock","An icon will be added to your Dock so you can quickly access this website.":"一個圖示將被加入你的 Dock，以便你可以快速存取這個網站。","An icon will be added to your home screen so you can quickly access this website.":"一個圖示將被加入你的主畫面，以便你可以快速存取這個網站。","An icon will be added to your Taskbar so you can quickly access this website.":"一個圖示將被加入你的工作列，以便你可以快速存取這個網站。","Install":"安裝","Install %s":"安裝 %s","Install and create shortcut":"安裝並建立捷徑","Install app":"安裝應用程式","Later":"稍後","Open in browser":"在瀏覽器中開啟","Select %s from the menu.":"從選單中選擇 %s。","Share":"分享","Tap":"點擊","Select %s from the menu that pops up.":"從跳出的選單中選擇 %s。","Tap %s":"點擊 %s","Tap %s in the browser bar.":"在瀏覽器列中點擊 %s。","Tap %s in the menu.":"在選單中點擊 %s。","Tap %s in the toolbar.":"在工具列中點擊 %s。","Tap the %s button above.":"點擊上面的 %s 按鈕。","Tap the %s button below to open your system browser.":"點擊下面的 %s 按鈕以開啟你的系統瀏覽器。","Tap the %s button in the toolbar.":"點擊工具列中的 %s 按鈕。","Tap the %s button in the upper right corner.":"點擊右上角的 %s 按鈕。","View More":"查看更多","You may need to scroll down to find this menu item.":"你可能需要向下捲動才能找到這個選單項目。"}');
