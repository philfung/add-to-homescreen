(() => {
  var e = {
      ...
      607: function (e, t, o) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.AddToHomeScreen = function (e) {
            ...
            function v() {
              return !!m() && b(/FBAN|FBAV/);
            }
            function T() {
              return !!m() && b(/LinkedInApp/);
            }
            function g() {
              return (
                !!m() && !!window.document.referrer.match("//l.instagram.com/")
              );
            }
            function S() {
              return g();
            ...
            function I() {
              return !!m() && !!window.document.referrer.match("//t.co/");
            }
            function A() {
              return h() && !!b(/Chrome/) && !D() && !j() && !_();
            }
            function D() {
              return h() && b(/FBAN|FBAV/);
            }
            function j() {
              return h() && b(/SamsungBrowser/);
            }
            function _() {
              return h() && b(/Firefox/);
            }
            function q() {
              return c.includes("Macintosh");
            }
            function z() {
              const e = c.includes("Chrome") && !c.includes("Edg"),
                t =
                  c.includes("Windows") ||
                  c.includes("Macintosh") ||
                  c.includes("Linux");
              return e && t;
            }
            function O() {
              const e =
                  ...
                  !c.includes("Chrome") &&
                  !c.includes("Edg"),
                t = c.includes("Macintosh") || c.includes("Windows");
              return e && t;
            }
            function L() {
              return c.includes("Edg/");
            }
            function E(e, t) {
              if (!t)
                throw new Error(
            ...
            function N(e, t) {
              return ` ${oe("list-item")} ${oe("number-container")} ${oe(
                "circle"
              )} ${oe("number")} ${e}</div></div></div> ${oe(
                "instruction"
              )} ${t}</div></div>`;
            }
            function B(e, t = "", o = "none") {
              if (t) {
                if ("right" === o)
                  return (
                    ` ${oe("list-button")} ${oe(
                      "list-button-text"
                    )} ${t}</div><img class="adhs-list-button-image-right" src="` +
                    e +
                    '" /></div>'
                  );
                if ("left" === o)
              ...
              var t =
                ...
                N(
                  ...
                  i.default.__(
                    ...
                    `<img class="adhs-more-button" src="${C(
                ...
                N(
                  ...
                  `${i.default.__(
                    "Tap"
                  )} <span class="adhs-emphasis">${i.default.__(
                    "Open in browser"
                  )}</span>`
                ) +
                "</div></div>" +
                ...
                '<img src="' +
                C("generic-vertical-up-bouncing-arrow.svg") +
                '" alt="arrow" /></div>';
              (e.innerHTML = t),
                e.classList.add(
                  "adhs-mobile",
            ...
            function Y() {
              return "inline" === n ? "" : oe("app-name") + o + "</div>";
            }
            function J() {
              return (
                oe("app-url") +
            ...
            function Z() {
              return (
                "number" == typeof l && l >= 0 && void 0 !== window.localStorage
              );
            }
            function R() {
              return !!Z() && Q() >= l;
            ...
            function Q() {
              var e,
                t = window.localStorage.getItem("adhs-modal-display-count");
              return (
                null === t
                  ? ((e = 0),
                    window.localStorage.setItem(
            ...
            E("appName", "string" == typeof o && o.length > 0),
              E("appIconUrl", "string" == typeof t && t.length > 0),
              E("assetUrl", "string" == typeof a && a.length > 0),
              (l = void 0 === l ? -1 : l),
            ...
            return {
              ...
              show: function (e) {
                ...
                if (
                  ...
                  t = new s.DeviceInfo((n = !0), (a = !0), o);
                else if (R()) t = new s.DeviceInfo((n = !1), (a = !1), o);
                else if (m() || h()) {
                  var l = !0;
                  G();
                  var u = x(!1);
                  m()
                    ? y()
                          ...
                          var t =
                            ...
                            N(
                              ...
                              i.default.__(
                                ...
                                B(C("ios-safari-sharing-api-button-2.svg"))
                              )
                            ) +
                            N(
                              "2",
                            ...
                            '<img src="' +
                            C("ios-safari-bouncing-arrow.svg") +
                            '" alt="arrow" /></div>';
                          (e.innerHTML = t),
                            e.classList.add(
                              "adhs-mobile",
                          ...
                          var t =
                            ...
                            N(
                              ...
                              i.default.__(
                                ...
                                B(C("ios-chrome-more-button-2.svg"))
                              )
                            ) +
                            N(
                              "2",
                            ...
                            K() +
                            "</div>" +
                            oe("ios-chrome-bouncing-arrow-container") +
                            '<img src="' +
                            C("ios-chrome-bouncing-arrow.svg") +
                            '" alt="arrow" /></div>';
                          (e.innerHTML = t),
                            e.classList.add(
                              "adhs-mobile",
                      ...
                      : v() || T()
                      ? ((t = new s.DeviceInfo((n = !1), (a = !1), o)), $(u))
                      : g() || S() || I()
                      ? ((t = new s.DeviceInfo((n = !1), (a = !1), o)),
                        (function (e) {
                          var t =
                            M() +
                            U() +
                            ...
                            '<img src="' +
                            C("generic-vertical-down-bouncing-arrow.svg") +
                            '" alt="arrow" /></div>';
                          (e.innerHTML = t),
                            e.classList.add(
                              "adhs-mobile",
                        ...
                        var t =
                          ...
                          N(
                            ...
                            i.default.__(
                              ...
                              B(C("android-chrome-more-button-2.svg"))
                            )
                          ) +
                          N(
                            "2",
                          ...
                          K() +
                          "</div>" +
                          oe("android-chrome-bouncing-arrow-container") +
                          '<img src="' +
                          C("android-chrome-bouncing-arrow.svg") +
                          '" alt="arrow" /></div>';
                        (e.innerHTML = t),
                          e.classList.add(
                            "adhs-mobile",
                    ...
                    : D()
                    ? ((t = new s.DeviceInfo((n = !1), (a = !1), o)), $(u))
                    : ((t = new s.DeviceInfo((n = !1), (a = !1), o)), (l = !1)),
                    l && H(u);
                } else
                  (t = new s.DeviceInfo((n = !1), (a = !1), o)),
                    z() || L()
                          ...
                          (function (e) {
                            var t = q() ? V() : W(),
                              o =
                                ...
                                t +
                                "</div>" +
                                oe("desktop-safari-bouncing-arrow-container") +
                                '<img src="' +
                                C("desktop-safari-bouncing-arrow.svg") +
                                '" alt="arrow" /></div>';
                            (e.innerHTML = o),
                              e.classList.add(
                                "adhs-desktop",
              ...
              closeModal: p,
              isBrowserAndroidChrome: A,
              isBrowserAndroidFacebook: D,
              isBrowserAndroidFirefox: _,
              isBrowserAndroidSamsung: j,
              isBrowserIOSChrome: f,
              isBrowserIOSFirefox: k,
              isBrowserIOSInAppFacebook: v,
              isBrowserIOSInAppInstagram: g,
              isBrowserIOSInAppLinkedin: T,
              isBrowserIOSInAppThreads: S,
              isBrowserIOSInAppTwitter: I,
              isBrowserIOSSafari: y,
              isDesktopChrome: z,
              isDesktopEdge: L,
              isDesktopMac: q,
              isDesktopSafari: O,
              isDesktopWindows: function () {
                return c.includes("Windows");
              },
            };
          }),
          o(279);
      ...
      699: (e, t) => {
        ...
        var o;
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.DeviceInfo = t.DeviceType = void 0),
          (function (e) {
