...
class AddToHomeScreen {
  ...
  _createContainer(include_modal = false) {
    ...
    if (include_modal) {
      var containerInnerHTML =
        this._genLogo() + this._genModalStart() + this._genModalEnd();
    ...
    var containerInnerHTML =
      ...
      this._genListItem(
        ...
        i18n.__(
          ...
          this._genListButtonWithImage(
            this._genAssetUrl("ios-safari-sharing-api-button-2.svg")
          )
        )
      ) +
      this._genListItem(
        ...
        i18n.__(
          ...
          this._genListButtonWithImage(
            this._genAssetUrl("ios-safari-add-to-home-screen-button-2.svg"),
    ...
    var containerInnerHTML =
      ...
      this._genListItem(
        ...
        i18n.__(
          ...
          this._genListButtonWithImage(
            this._genAssetUrl("ios-chrome-more-button-2.svg")
          )
        )
      ) +
      this._genListItem(
    ...
    var containerInnerHTML =
      ...
      this._genListItem(
        ...
        i18n.__(
          ...
          `<img class="adhs-more-button" src="${this._genAssetUrl(
    ...
    var containerInnerHTML =
      ...
      this._genListItem(
        ...
        i18n.__(
          ...
          this._genListButtonWithImage(
            this._genAssetUrl("android-chrome-more-button-2.svg")
          )
        )
      ) +
      this._genListItem(
        ...
        i18n.__(
          "Tap %s",
          this._genListButtonWithImage(
            this._genAssetUrl("android-chrome-add-to-home-screen-button-2.svg"),
            i18n.__("Add to Home Screen"),
            "left"
          )
        )
  ...
  _genBlurbMobile() {
    return this._genBlurbWithMessage(
      i18n.__(
  ...
  _genDesktopChrome = (container: HTMLElement) => {
    var blurb: string = this.isDesktopMac()
    ...
    installButton.addEventListener("click", () => {
      ...
      this._desktopInstallPromptEvent.userChoice.then(
    ...
    var containerInnerHTML =
      ...
      this._genListItem(
        ...
        i18n.__(
          ...
          this._genListButtonWithImage(
            this._genAssetUrl("desktop-safari-menu.svg")
          )
        )
      ) +
      this._genListItem(
        ...
        i18n.__(
          "Tap %s",
          this._genListButtonWithImage(
            this._genAssetUrl("desktop-safari-dock.svg"),
            i18n.__("Add To Dock"),
            "left"
          )
        )
  ...
  _registerDesktopInstallPromptEvent() {
    window.addEventListener(
      "beforeinstallprompt",
      this._desktopInstallPromptEventListener
    );
  }
